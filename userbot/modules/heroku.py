...
from userbot import BOTLOG, BOTLOG_CHATID, CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME, RAILWAY_GIT_REPO_NAME
...
async def variable(var):
    if RAILWAY_GIT_REPO_NAME == "ProjectFizilion":
        await var.edit("You Are using Railway, This command can't be used")
        return
    elif app == None:
        await var.edit("You are not using Heroku, This command can't be used")
        return
    else:
...
async def dyno_usage(dyno):
    ...
    """
    if RAILWAY_GIT_REPO_NAME == "ProjectFizilion":
        await dyno.edit("You Are using Railway,, This command can't be used")
        return
    elif app == None:
        await dyno.edit("You are not using Heroku, This command can't be used")
        return
    else:
